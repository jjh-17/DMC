  ...
  return (
    <>
      ...
      >
        ...
        <InfoDiv title="리뷰 분석을 보고 판단하세요" description={["리뷰어와 리뷰 내용을 실시간으로 분석합니다.", "신뢰도와 긍정/부정 여부를 제공합니다."]} delay={[0.7, 0.9, 0.9]} icon="analysis" />
        <InfoDiv title="나만의 카페를 찾아서 모으세요" description={["좋아하는 카페를 북마크하고 리뷰를 작성하세요.", "북마크한 카페와 작성한 리뷰를 한번에 볼 수 있습니다."]} delay={[0.5, 0.7, 0.7]} icon="bookmark" />
      </div>
    </>
  )
}
