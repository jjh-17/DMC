      ...
      <div className="bg-gray-100 h-screen justify-center">
        <center className="mt-24 m-auto">
          ...
          <div className=" tracking-widest mt-4">
            <span className="text-primary2 text-8xl block"><span>404</span></span>
            <span className="text-gray-500 my-4 text-xl">원하시는 페이지가 존재하지 않습니다</span>

          </div>
        </center>
        <center className="mt-6">
          <Button label="홈으로" onClick={() => navigate('/')}></Button>
          <Button label="뒤로가기" onClick={() => navigate(-1)}></Button>
        </center>
      </div>
    </>
  );
