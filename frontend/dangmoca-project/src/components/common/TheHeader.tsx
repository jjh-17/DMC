    ...
    useEffect(() => {
        const handleScroll = () => {
            ...
            const newHeaderClass = window.scrollY > limitHeight ?
                'fixed top-0 w-full bg-white pointer-events-none opacity-0 duration-500 bg-transparent' :
                'fixed top-0 w-full bg-white opacity-100 duration-500 bg-transparent';
