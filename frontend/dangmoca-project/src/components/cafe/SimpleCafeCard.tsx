...
const SimpleCafeCard = (cafe : any) => {
  ...
  return (
    <div className="w-44 p-3 flex flex-col m-4 items-center shadow-md">
      ...
      <h1 className="text-xl font-thin m-2 max-w-40 whitespace-pre-wrap">{cafe.name}</h1>
      <p className="text-[12px] font-light text-slate-700 max-w-40 whitespace-pre-wrap">{cafe.address}</p>
