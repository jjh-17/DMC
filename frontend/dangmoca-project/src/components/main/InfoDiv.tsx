  ...
  return (
    <div
      className="flex flex-col justify-around
        w-fit px-[5lvw] pt-[5lvh] pb-[15lvh] h-fit items-center text-center">
      <div>
        <motion.h1
          initial={initial} whileInView={whileInView} viewport={viewport} transition={{
            duration: 0.8, delay: props.delay[0]
          }}
          className="text-3xl md:text-4xl whitespace-pre-wrap text-primary2"
          id="test"
        ...
        <motion.p
          ...
          className="whitespace-pre-wrap text-3xl mb-2"
          id="test"
