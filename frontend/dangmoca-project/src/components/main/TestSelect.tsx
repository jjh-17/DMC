...
export default function TestSelect(props: Props) {
    let divClass = "cursor-pointer mx-auto m-5 flex flex-col whitespace-pre-wrap h-[45lvh] w-[80lvw] md:w-[25lvh] lg:w-[35lvh] items-center gap-4 text-center justify-center border-4 border-primary p-2 hover:text-2xl";
