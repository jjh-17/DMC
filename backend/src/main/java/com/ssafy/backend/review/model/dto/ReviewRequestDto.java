...
import static com.ssafy.backend.global.response.BaseResponseStatus.NOT_VALID_CONTENT;
...
public class ReviewRequestDto {
    ...
    public ReviewRequestDto(List<MultipartFile> reviewImages, String content, List<String> tag, Integer rating) {
